...
class Recwalk_PR(Recommender):
    """

    Parameters
    ----------
    name: string, optional, default: 'Recwalkᴾᴿ'
    ...
    * Athanasios N. Nikolakopoulos and George Karypis. 2019. RecWalk: Nearly Uncoupled Random Walks for Top-N Recommendation. 
    ...
    def fit(self, train_set, val_set=None):
        ...
        if self.imodel=="cosine":
            # print("item model is cosine similarity")
            # Normalization
        ...
        # slim similarity
            ...
            # print("item model is gram similarity")
        ...
        # Page-Rank
        self.P = torch.inverse( torch.eye(self.nM + self.nU).to(devi) - (self.eta * self.P) )
        self.P = self.P[:self.nU, self.nU:]
